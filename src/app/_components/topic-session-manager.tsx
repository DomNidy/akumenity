    ...
    return <Card className="w-fit p-2 space-x-2 space-y-2">
        ...
        <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
                <Button role="combobox" aria-expanded={open} className="w-[250px] justify-between">
                    {value ? usersTopics.data?.find((topic) => (topic.value.toLowerCase() === value.toLowerCase()))?.label : "Select Topic"}
